...
const translations = {
  fr: {
    ...
    confirmation: {
      ...
      skipQueue: "Ne faites pas la queue : allez directement à la caisse, votre commande vous y attend.",
  ...
  en: {
    ...
    confirmation: {
      ...
      skipQueue: "No need to queue: go straight to the till, your order is waiting for you there.",
